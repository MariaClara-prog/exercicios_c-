...
---
## 🚀 Sobre os Exercícios
Cada arquivo `.cpp` contém o enunciado detalhado e a minha solução para o problema proposto. Os tópicos abordados incluem:

1. **Entrada e Saída de Dados:** Manipulação de `cin` e `cout`.
2. **Cálculos Matemáticos:** Operadores aritméticos e expressões.
3. **Uso de bibliotecas:** <iostream> e <math.h>.
